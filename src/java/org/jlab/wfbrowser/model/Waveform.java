...
/**
 * This an object just to represent waveform data.  The object can be instantiated with or without supplying data, and supports
 * adding timeOffset/value pairs.  Should be used in conjunction with a "parent" Event object that contains information system
 * location, and waveform trigger "event" time.
 * @author adamc
 */
