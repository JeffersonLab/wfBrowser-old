...
@WebServlet(name = "Servlet", urlPatterns = "/reports/rf-fault-summary")
public class RFFaultSummary extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (redirectNeeded) {
            StringBuilder redirectUrl = new StringBuilder(request.getContextPath() + "/reports/rf-fault-summary?" +
